...
public class Parrot extends Bird {
    ...
    // Parrot의 날개 퍼덕임을 위한 이미지, 날개 위 아래 + 새의 머리 좌 우 향한 모습의 4개 이미지
    ...
    public void goRight() {
        parrotLabel.setLocation(parrotLabel.getX() + 25, parrotLabel.getY()-5); // 오른쪽으로 이동
    ...
    public void goLeft() {
        parrotLabel.setLocation(parrotLabel.getX() - 25, parrotLabel.getY()+5); // 왼쪽으로 이동
